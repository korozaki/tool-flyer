...
webbrowser.open('https://www.youtube.com/channel/UCPdeJOzfA_NE-ITMI5WnZsg?view_as=subscriber')
...
if password == passwd:
    ...
    print ("\n \033[0;34m[17]update & upgrade Termux")
    print ("\n \033[0;34m[18]update & upgrade Kali Linux")
    print ("\n \033[0;34m[19]exit ")
else:
